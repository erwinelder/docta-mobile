...
class SaveOMOCourseToDatabaseUseCase(
    ...
    private val updateTime1 = 202501121325



    /* Course */

    private val course = CourseRemoteEntity(
    ...
    suspend fun execute() {
        ...
        courseDao.upsertCourses(listOf(course))
...
fun saveOMOCourseToDatabaseUseCaseFactory(
    appRemoteDatabase: AppRemoteDatabase
): SaveOMOCourseToDatabaseUseCase {
    return SaveOMOCourseToDatabaseUseCase(
