    ...
    ScreenPreviewContainer(appTheme = appTheme) {
        OpenAnswerQuestionScreen(
            ...
            questionMaterials = listOf(
                ...
                Materials(
                    id = 3,
                    text = "Materials text of 3, which is much much longer than in first one."
                ),
                Materials(
                    id = 4,
                    text = "Materials text of 4, which should be the longest of them all, longer than in first and second one."
                )
            ),
